...
return [
    ...
    Settings::KEY_SERVER_ORIGIN => [
        'scheme' => env('API_KEY_SERVER_ORIGIN_SCHEME', 'http'),
        'host'   => env('API_KEY_SERVER_ORIGIN_HOST', 'clockin.app'),
        'port'   => env('API_KEY_SERVER_ORIGIN_PORT', 80),
    ],
    ...
    Settings::KEY_ALLOWED_ORIGINS => [
        '*' => env('API_ALLOWED_FOR_EVERYONE', null),
